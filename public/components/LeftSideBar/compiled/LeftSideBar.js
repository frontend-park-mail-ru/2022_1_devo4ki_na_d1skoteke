...
var pug_match_html=/["&<>]/;
function pug_rethrow(e,n,r,t){if(!(e instanceof Error))throw e;if(!("undefined"==typeof window&&n||t))throw e.message+=" on line "+r,e;var o,a,i,s;try{t=t||require("fs").readFileSync(n,{encoding:"utf8"}),o=3,a=t.split("\n"),i=Math.max(r-o,0),s=Math.min(a.length,r+o)}catch(t){return e.message+=" - could not read from "+n+" ("+t.message+")",void pug_rethrow(e,null,r)}o=a.slice(i,s).map(function(e,n){var t=n+i+1;return(t==r?"  > ":"    ")+t+"| "+e}).join("\n"),e.path=n;try{e.message=(n||"Pug")+":"+r+"\n"+o+"\n\n"+e.message}catch(e){}throw e}function LeftSideBar(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {;
...
pug_html = pug_html + "\u003Cdiv class=\"notion__sidebar__deathnote__item\"\u003E";
;pug_debug_line = 32;pug_debug_filename = "public\u002Fcomponents\u002FLeftSideBar\u002FLeftSideBar.pug";
pug_html = pug_html + "\u003Cdiv class=\"notion__sidebar__deathnote__item__bio\"\u003E";
;pug_debug_line = 33;pug_debug_filename = "public\u002Fcomponents\u002FLeftSideBar\u002FLeftSideBar.pug";
pug_html = pug_html + "Note&apos;s Name &amp; Pic\u003C\u002Fdiv\u003E";
;pug_debug_line = 34;pug_debug_filename = "public\u002Fcomponents\u002FLeftSideBar\u002FLeftSideBar.pug";
pug_html = pug_html + "\u003Cdiv class=\"notion__sidebar__deathnote__item__action\"\u003E";
...
pug_html = pug_html + "New page\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
    ...
    ;} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;} export {LeftSideBar}